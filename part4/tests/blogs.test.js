...
describe('most post author', () => {
  test('the author with most blogs', () => {
    const top_entry = { author: 'Robert C. Martin', blogs: 3 }
    assert.deepStrictEqual(listHelper.mostBlogs(blogs), top_entry)
  })
})
...
describe('most likes author', () => {
  test('the author with most likes', () => {
    ...
    assert.deepStrictEqual(listHelper.mostLikes(blogs), top_entry)
  })
})
